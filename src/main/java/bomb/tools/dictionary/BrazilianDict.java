    ...
    public String predictWord(String part, boolean isMorse) {
        if (!isMorse) {
            switch (part.toLowerCase()) {
                case "i": case "is": case "iss": return  "isso";
                case "no": case "n": case "nao": case "nã": case "na": return "não";
                case "6": return "^";
                case "v": case "vi": case "vis": case "viso": return "visor";
                case "nad": case "nd": return "nada";
                case "p": case "pr": case "pro": case "pron": case "pront": return "pronto";
                case "pri": case "prim": case "prime": case "primei": case "primeir": return "primeiro";
                case "b": case "br": case "bra": case "bran": case "branc": return "branco";
                case "q": case "qu": case "que": case "qe": case "qê": return "quê";
                case "s": case "se": case "sei": case "si": return "sei";
                case "ses": case "sis": return "seis";
                case "e": case "es": case "esq": case "esqu": case "esque": case "esquer": case "esquerd": return "esquerda";
                case "d": case "di": case "dir": case "dire": case "direi": case "direit": return "direita";
                case "m": case "me": case "mei": return "meio";
                case "be": case "bel": case "bele": case "belez": return "beleza";
                case "a": case "ap": case "ape": case "aper": case "apert": return "aperta";
                case "vo": case "voc": case "voce": case "vce": case "voe": return "você";
                case "c": case "ce": case "ces": case "cest": return "cesto";
                case "sex": case "sext": return "sexto";
                case "c ": return "c e";
                case "ê é": case "e e": case "ce e": case "cee": case "cêé": return "cê é";
                case "q?": case "qu?": case "que?": return "quê?";
                case "seg": case "segu": case "segur": return "segura";
                case "f": case "fo": case "fi": return "foi";
                case "pró": case "prox": case "próx": case "proxi": case "próxi": case "proxim": case "próxim": case "proximo": return "próximo";
                case "t": case "ti": case "tip": case "tpo": case "tp": return "tipo";
                case "em": case "emp": case "empt": return "empty";
                case "esc": case "escr": case "escri": case "escrit": return "escrito";
                case "ac": case "ace": case "acen": case "acent": return "acento";
                case "cel": case "cla": return "cela";
                case "2": return "2S";
                case "asse": case "assen": case "assent": return "assento";
                case "s la": case "sla": case "seila": case "sei la": return "sei lá";
                case "sel": return "sela";
                case "pe": case "per": case "pera": case "perai": case "peria": case "peraí": return "pería";
                case "voce e": case "você e": case "vocêé": return "você é";
                case "ess": return "esse";
                case "as": case "ass": case "ao": case "aso": return "asso";
                case "aco": return "aço";
                default: return part;
            }
        }
        switch (part.toLowerCase()){
            case "b": case "bu": case "bur": case "burr": case "brr": case "brro": return "burro";
            case "bo": case "bos": case "boss": return "bossa";
            case "bom": case "bomb": return "bomba";
            case "ba": case "bat": case "bato": return "batom";
            case "bombo": case "bbom": return "bombom";
            case "d": case "da": case "dad": case "dado": return "dados";
            case "do": case "dos": case "doss": case "dossi": case "dossie": return "dossiê";
            case "m": case "mo": case "mor": case "mors": return "morse";
            case "doi": case "doid": return "doido";
            case "mod": case "modu": case "modul": return "modulo";
            case "s": case "se": case "sen": case "senh": return "senha";
            case "ser": case "seri": case "seria": return "serial";
            case "sa": case "sam": case "samb": return "samba";
            case "c": case "ch": case "cha": case "chav": case "chva": return "chave";
            case "co": case "cod": case "codi": case "codig": return "codigo";
            case "con": case "cont": return "conta";
            default: return part;
        }
    }
