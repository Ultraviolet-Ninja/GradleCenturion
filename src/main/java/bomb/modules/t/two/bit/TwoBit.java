...
import static bomb.modules.t.two.bit.TwoBitState.SECOND_QUERY;
import static bomb.modules.t.two.bit.TwoBitState.SUBMIT;
 ...
 *
 */
@DisplayComponent(resource = "two_bit.fxml", buttonLinkerName = "Two Bit")
