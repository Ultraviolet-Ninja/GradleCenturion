...
public class OnFirst extends TranslationCenter {
    ...
    private static String format(String initial){
        ...
        switch (initial.toLowerCase()) {
            ...
            case "wt":
            case "wat":
            case "wit": return "wait";
            case "redy":
            case "rdy":
            case "ry": return "ready";
            case "b":
            case "blk":
            case "blnk":
            case "bnk":
            ...
            case "pres":
            case "prss":
            case "ress": return "press";
            case "rig":
            case "righ":
            case "ryt":
            case "rye": return "right";
            case "mid":
            case "mi":
            case "midd":
            case "middl" : return "middle";
            case "nex":
            case "ne":
            case "xt" : return "next";
            case "s":
            case "su":
            case "ure" : return "sure";
            case "e":
            case "ty":
            case "em":
            case "emp":
            case "ep":
            case "ept": return "empty";
            case "l" : return "led";
            case "le":
            case "lee" : return "leed";
            case "la":
            case "lea" : return "lead";
            case "li":
            case "ike":
            case "lik":
            case "lke" : return "like";
            case "r":
            case "rd" : return "red";
            case "ree":
            case "re" : return "reed";
            ...
            case "ra": return "read";
            case "ho":
            case "hol" : return "hold";
            case "holdn":
            case "holdon":
            case "hod":
            case "hoon":
            case "holon":
            case "holn" : return "hold on";
            case "d":
            case "di":
            case "dis":
            case "disp":
            case "displ":
            case "displa" : return "display";
            case "do":
            case "don":
            case "dne":
            case "one" : return "done";
            case "uh":
            case "uh u":
            case "uhu":
            case "uhuh" : return "uh uh";
            case "yre":
            case "y're":
            case "y'r":
            case "yr'":
            ...
            case "yor'":
            case "yor'e":
            case "yur'e": return "you're";
            case "uh h":
            case "uh ":
            case "uhh":
            case "uhhuh" : return "uh huh";
            case "yur":
            case "yure":
            case "youare":
            case "you ":
            ...
            case "yoar":
            case "yuar":
            case "yua": return "you are";
            case "q":
            case "?":
            case "wq":
            case "whatq" : return "what?";
            case "tyre":
            case "th're":
            case "ty're":
            case "t're":
            ...
            case "theyare":
            case "thya":
            case "thy" : return "they are";
            case "wht":
            case "wh":
            case "wnq" : return "what";
            case "ye":
            case "es" : return "yes";
            case "yor":
            case "our":
            ...
            case "oka":
            case "oak":
            case "oaky" : return "okay";
            case "sa":
            case "say":
            case "sys" : return "says";
            case "f":
            case "fir":
            case "firs":
            case "fi":
            ...
            case "not":
            case "noth" : return "nothing";
            case "ere" : return "there";
            case "eir":
            case "ir" : return "their";
            case "lef":
