...
public class NewForgetMeNot extends Widget {
    ...
    private int createFirstNumber(int stageNumber){
    ...
    private int createSecondNumber(int stageNumber){
    ...
    private int createSucceedingNumber(int stageNumber){
