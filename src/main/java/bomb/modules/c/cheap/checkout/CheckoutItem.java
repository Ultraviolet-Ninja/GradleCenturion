...
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.CARE;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.DAIRY;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.FRUIT;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.GRAIN;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.OIL;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.OTHER;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.PROTEIN;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.SWEET;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.VEGETABLE;
import static bomb.modules.c.cheap.checkout.CheckoutItem.Category.WATER;
